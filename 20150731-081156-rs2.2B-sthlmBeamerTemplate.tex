...
\subtitle{sthlm v2.0.0 is based on hsrm \& mTheme}
\date{\today}
...
\alert{sthlm} continues to be a theme that can easily be modfied through the style files.  If you are looking for a packaged theme, then I highly recommend \alert{mTheme}.\\

\vspace{1em}

I use a custom version of \alert{sthlm} for daily decks and make a vanilla version of the theme available for others to use and modifiy. - Enjoy!
...
If you have read this far, then you are probably interested in using / modifiying this theme for your own project. \\
\vspace{1em}
...
\centering{\Huge{Blue Background}}
...
\begin{itemize}
	...
	\item \emph{cabin} for sans-serif
